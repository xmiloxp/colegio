...
export default function configureStore(initialState = {}, fromServer) {
  ...
  const middleware = composeWithDevTools(applyMiddleware(initializedRouterMW, thunk, promiseMiddleware));
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    if (module.hot) {
      ...
      module.hot.accept('../redux/reducers', () => store.replaceReducer(require('../redux/reducers')));
    }
  }
